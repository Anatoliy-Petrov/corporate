    ...
    <ul>
        ...
        <li class="submenu-title"><a href="#" data-toggle="dropdown"  class="nav-link dropdown-toggle"><i class="fa fa-calculator" aria-hidden="true"></i>Калькулятор<span class="caret"></span></a>
            <ul class="submenu">
                ...
                <li id="gadgets-requests" @if(Route::is('gadget.requests.index')) class="current" @endif><a href="{{ route('gadget.requests.index') }}"><i class="fa fa-paper-plane" aria-hidden="true"></i>Заявки Техника</a></li>
            </ul>
        </li>
