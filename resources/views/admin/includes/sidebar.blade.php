    ...
    <ul>
        <li class="submenu-title"><a href="#" data-toggle="dropdown"  class="nav-link dropdown-toggle"><i class="fa fa-sticky-note" aria-hidden="true"></i>Контент<span class="caret"></span></a>
            <ul class="submenu">
                ...
                <li id="clients" @if(Route::is('clients')) class="current" @endif ><a href="{{ route('clients') }}"><i class="fa fa-user-o" aria-hidden="true"></i>Клиентам</a></li>
        ...
        <li id="regions" @if(Route::is('regions')) class="current" @endif ><a href="{{ route('regions') }}"><i class="fa fa-map" aria-hidden="true"></i></i>Регионы</a></li>
        <li id="cities" @if(Route::is('cities')) class="current" @endif ><a href="{{ route('cities') }}"><i class="fa fa-map-marker" aria-hidden="true"></i></i></i>Города</a></li>
