        ...
        <div class="row">
            ...
            <div class="col-sm-3">
                ...
                <div class="form-group">
                    ...
                    <div class="clearfix">
                        <div class="card card-body bg-light col-sm-4 float-left">
                            <span style="color: #28a745">Хорошо</span>
                            <img src="/img/code.png" alt="Card image cap"  class="img-fluid">
                            <a href="#" class="card-link">скачать</a>
                        </div>
                        <div class="card card-body bg-light col-sm-4 float-left">
                            <span style="color: #ffc107">Так себе</span>
                            <img src="/img/code.png" alt="Card image cap"  class="img-fluid">
                            <a href="#" class="card-link">скачать</a>
                        </div>
                        <div class="card card-body bg-light col-sm-4 float-left">
                            <span style="color: #a92222">Плохо</span>
                            <img src="/img/no-code.png" alt="Card image cap"  class="img-fluid">
                            <a href="#" class="card-link upload_code_link" id="upload_code_link">загрузить</a>
                            <input class="upload_code_input" style="display: none" name="code1" type="file"/>
                            {{--<a href="#" class="card-link">скачать</a>--}}
                        </div>
                    </div>

                    {{----}}
                    {{--<div class="col-sm-4"><img src="/img/wedding-ring.jpg" alt=""></div>--}}
                    {{--<div class="col-sm-4"><img src="/img/wedding-ring.jpg" alt=""></div>--}}
                    {{--<div class="col-sm-4"><img src="/img/wedding-ring.jpg" alt=""></div>--}}
                </div>
            </div>
